...
describe("Lang2FhirClient", () => {
    ...
    test("search (1)", async () => {
        ...
        const rawResponseBody = { resource_type: "Appointment", search_params: "date=ge2025-03-02&date=le2025-03-09" };
    ...
    test("document (8)", async () => {
        ...
        }).rejects.toThrow(phenoml.lang2Fhir.GatewayTimeoutError);
    });
