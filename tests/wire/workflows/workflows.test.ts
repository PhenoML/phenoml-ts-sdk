...
describe("Workflows", () => {
    test("list (1)", async () => {
        ...
        const response = await client.workflows.workflows.list({
            verbose: true,
        });
    ...
    test("list (2)", async () => {
        ...
        await expect(async () => {
            return await client.workflows.workflows.list();
    ...
    test("create (1)", async () => {
        ...
        const response = await client.workflows.workflows.create({
            verbose: true,
            name: "Patient Data Mapping Workflow",
            workflow_instructions: "Given diagnosis data, find the patient and create condition record",
            sample_data: {
    ...
    test("create (2)", async () => {
        ...
        await expect(async () => {
            return await client.workflows.workflows.create({
                name: "name",
                workflow_instructions: "workflow_instructions",
                sample_data: {
                    sample_data: {
    ...
    test("get (1)", async () => {
        ...
        const response = await client.workflows.workflows.get("id", {
            verbose: true,
        });
        expect(response).toEqual({
            success: true,
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.workflows.workflows.get("id");
        }).rejects.toThrow(phenoml.workflows.UnauthorizedError);
    });
    ...
    test("update (1)", async () => {
        ...
        const response = await client.workflows.workflows.update("id", {
            verbose: true,
            name: "Updated Patient Data Mapping Workflow",
            workflow_instructions: "Given diagnosis data, find the patient and create condition record",
            sample_data: {
    ...
    test("update (2)", async () => {
        ...
        await expect(async () => {
            return await client.workflows.workflows.update("id", {
                name: "name",
                workflow_instructions: "workflow_instructions",
                sample_data: {
                    sample_data: {
    ...
    test("delete (1)", async () => {
        ...
        const response = await client.workflows.workflows.delete("id");
        expect(response).toEqual({
            success: true,
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.workflows.workflows.delete("id");
        }).rejects.toThrow(phenoml.workflows.UnauthorizedError);
    });
    ...
    test("execute (1)", async () => {
        ...
        const response = await client.workflows.workflows.execute("id", {
            input_data: {
                patient_last_name: "Johnson",
                patient_first_name: "Mary",
                diagnosis_code: "M79.3",
    ...
    test("execute (2)", async () => {
        ...
        await expect(async () => {
            return await client.workflows.workflows.execute("id", {
                input_data: {
                    input_data: {
                        key: "value",
                    },
