# Reference
## Agent
<details><summary><code>client.agent.<a href="/src/api/resources/agent/client/Client.ts">create</a>({ ...params }) -> phenoml.AgentPromptsResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.agent.<a href="/src/api/resources/agent/client/Client.ts">list</a>() -> phenoml.PromptsListResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.agent.<a href="/src/api/resources/agent/client/Client.ts">get</a>(id) -> phenoml.AgentPromptsResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.agent.<a href="/src/api/resources/agent/client/Client.ts">update</a>(id, { ...params }) -> phenoml.AgentPromptsResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.agent.<a href="/src/api/resources/agent/client/Client.ts">delete</a>(id) -> phenoml.PromptsDeleteResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.agent.<a href="/src/api/resources/agent/client/Client.ts">patch</a>(id, { ...params }) -> phenoml.AgentPromptsResponse</code></summary>
<dl>
<dd>
...
## Construe
<details><summary><code>client.construe.<a href="/src/api/resources/construe/client/Client.ts">list</a>(codesystem, { ...params }) -> phenoml.ListCodesResponse</code></summary>
<dl>
<dd>
...
```typescript
await client.construe.list("ICD-10-CM", {
    version: "2025",
    cursor: "cursor",
    limit: 1
});
...
**request:** `phenoml.construe.ConstrueListRequest` 
...
<details><summary><code>client.tools.<a href="/src/api/resources/tools/client/Client.ts">list</a>(mcp_server_id) -> phenoml.McpServerToolResponse</code></summary>
<dl>
<dd>
...
```typescript
await client.tools.list("mcp_server_id");
...
<details><summary><code>client.tools.<a href="/src/api/resources/tools/client/Client.ts">get</a>(mcp_server_tool_id) -> phenoml.McpServerToolResponse</code></summary>
<dl>
<dd>
...
```typescript
await client.tools.get("mcp_server_tool_id");
...
<details><summary><code>client.tools.<a href="/src/api/resources/tools/client/Client.ts">delete</a>(mcp_server_tool_id) -> phenoml.McpServerToolResponse</code></summary>
<dl>
<dd>
...
```typescript
await client.tools.delete("mcp_server_tool_id");
