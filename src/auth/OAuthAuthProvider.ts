...
const ENV_CLIENT_ID = "PHENOML_CLIENT_ID" as const;
const ENV_CLIENT_SECRET = "PHENOML_CLIENT_SECRET" as const;
...
export class OAuthAuthProvider implements core.AuthProvider {
    ...
    private readonly authClient: AuthtokenClient;
    ...
    constructor(options: OAuthAuthProvider.Options & OAuthAuthProvider.ClientCredentials) {
        ...
        this.authClient = new AuthtokenClient(options);
...
export namespace OAuthAuthProvider {
    export const AUTH_SCHEME = "PhenoMLOAuth" as const;
