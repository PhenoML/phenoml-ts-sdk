...
export declare namespace SummaryGenerationClient {
...
/**
 * Generate summaries from templates and FHIR resources
 */
export class SummaryGenerationClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<SummaryGenerationClient.Options>;

    constructor(options: SummaryGenerationClient.Options = {}) {
     ...
     * @param {SummaryGenerationClient.RequestOptions} requestOptions - Request-specific configuration.
     *
