...
export declare namespace FhirOperationsClient {
...
/**
 * Operations for interacting with FHIR resources through configured providers.
 * All operations act as a proxy to the underlying FHIR server with authentication handling.
 */
export class FhirOperationsClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<FhirOperationsClient.Options>;

    constructor(options: FhirOperationsClient.Options = {}) {
     ...
     * @param {FhirOperationsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
